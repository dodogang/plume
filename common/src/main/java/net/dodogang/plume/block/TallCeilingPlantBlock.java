...
/**
 * A double-tall version of the {@link CeilingPlantBlock}.
 */
@SuppressWarnings("unused")
public class TallCeilingPlantBlock extends PlantBlock {
    ...
    public void onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!world.isClient) {
            if (player.isCreative()) {
                TallCeilingPlantBlock.onBreakInCreative(world, pos, state, player);
            } else {
                TallCeilingPlantBlock.dropStacks(state, world, pos, null, player, player.getMainHandStack());
            }
        }
