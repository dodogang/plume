package net.dodogang.plume.datagen.models.stategen.helper;

import net.dodogang.plume.datagen.models.modelgen.InheritingModelGen;
import net.dodogang.plume.datagen.models.modelgen.ModelGen;
import net.dodogang.plume.datagen.models.stategen.*;
import net.minecraft.block.enums.BlockHalf;
import net.minecraft.util.math.Direction;

import static net.dodogang.plume.datagen.models.modelgen.InheritingModelGen.fencePost;
import static net.dodogang.plume.datagen.models.modelgen.InheritingModelGen.fenceSide;

@SuppressWarnings("unused")
public abstract class BuildingBlocksStateHelper {
