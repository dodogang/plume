...
public abstract class AbstractBlockLootTableCreator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
        ...
        Iterable<Block> blocks = Registry.BLOCK
                                     .stream()
                                     .filter(block -> Registry.BLOCK.getId(block).getNamespace().equals(this.getModId()))
                                     ::iterator;
    ...
    /*private void addWoodDrops(WoodBlocks blocks) {
        ...
        addDrop(blocks.DOOR, AbstractBlockLootTableCreator::dropsDoor);
    ...
    public void addSlabDrop(Block block) {
        addDrop(block, AbstractBlockLootTableCreator::dropsSlab);
    }
