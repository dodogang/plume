package net.dodogang.plume.datagen.models.modelgen;
...
public class InheritingModelGen implements ModelGen {
    ...
    public static InheritingModelGen grassBlock(String bottom, String top, String side, String overlay) {
        return new InheritingModelGen(new Identifier(Plume.MOD_ID, "block/layered_grass_block"))
                   .texture("bottom", bottom)
                   .texture("top", top)
                   .texture("side", side)
    ...
    public static InheritingModelGen flattenedBlock(String bottom, String top, String side) {
        return new InheritingModelGen(new Identifier(Plume.MOD_ID, "block/flattened_block"))
                   .texture("bottom", bottom)
                   .texture("top", top)
                   .texture("side", side);
    }
    ...
    public static InheritingModelGen doubleCross(String texture) {
        return new InheritingModelGen(new Identifier(Plume.MOD_ID, "block/double_cross"))
                   .texture("cross", texture);
    }
    ...
    public static InheritingModelGen wallSidedSide(String bottom, String top, String side) {
        return new InheritingModelGen(new Identifier(Plume.MOD_ID, "block/template_wall_sided_side"))
                   .texture("bottom", bottom)
                   .texture("top", top)
                   .texture("side", side);
    }
    ...
    public static InheritingModelGen wallSidedSideTall(String bottom, String top, String side) {
        return new InheritingModelGen(new Identifier(Plume.MOD_ID, "block/template_wall_sided_side_tall"))
                   .texture("bottom", bottom)
                   .texture("top", top)
                   .texture("side", side);
    }
    ...
    public static InheritingModelGen wallSidedPost(String bottom, String top, String side) {
        return new InheritingModelGen(new Identifier(Plume.MOD_ID, "block/template_wall_sided_post"))
                   .texture("bottom", bottom)
                   .texture("top", top)
                   .texture("side", side);
    }
    ...
    public static InheritingModelGen wallSidedInventory(String bottom, String top, String side) {
        return new InheritingModelGen(new Identifier(Plume.MOD_ID, "block/wall_sided_inventory"))
                   .texture("bottom", bottom)
                   .texture("top", top)
                   .texture("side", side);
    }
